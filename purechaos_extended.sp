...
public Action playerDeath(Event event, const char[] Spawn_Name, bool Spawn_Broadcast)
{
...
public Action SwitchImmed(int client){
	if(Chaos == false)
	{
...
public Action ForceSwitch(int client) {
	bool toSpec = false;
...
{
	static int ClassVal, NewClassVal = 0;
